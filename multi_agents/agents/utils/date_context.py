...
def is_temporal_issue(text: str) -> bool:
    ...
    temporal_indicators = [
        'future event', 'hasn\'t happened', 'not yet occurred',
        'will happen', 'upcoming', 'later this year', 'next year',
        'factually incorrect date', 'wrong year', 'anachronistic'
    ]
    ...
    substantive_indicators = [
        'format', 'structure', 'missing', 'incomplete', 'guideline',
        'clarity', 'grammar', 'citation', 'evidence', 'source',
        'organization', 'flow', 'coherence', 'methodology'
    ]
