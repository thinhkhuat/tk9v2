...
def test_network_improvements():
    ...
    try:
        from network_reliability_patch import apply_network_reliability_patches, setup_global_session_defaults
...
def test_startup_integration():
    ...
    try:
        ...
        os.chdir('/Users/thinhkhuat/DEV--local/multi-agent-deep-research/deep-research-mcp-og/multi_agents')
