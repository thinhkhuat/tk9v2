...
from multi_agents.providers.base import (
    ...
    LLMResponse, SearchResponse, SearchResult
)
...
class MockProviderFactory:
    ...
    def create_search_provider(self, provider_type: str, config: Dict[str, Any]) -> MockSearchProvider:
