...
class TestTranslationSelectionLogic:
    ...
    def setup_method(self):
        ...
        self.sample_content = "This is a sample research report with multiple sections and detailed content."
...
class TestEdgeCaseHandling:
    ...
    async def test_short_content_handling(self):
        ...
        # Very short content
        short_content = "Hi"
        result = await self.translator._translate_markdown_content(short_content, "Vietnamese", "vi", {})
...
class TestStateManagement:
    ...
    async def test_research_state_flow(self):
        ...
        with patch.object(translator, '_translate_markdown_content', return_value="Translated content"):
        ...
        with patch('multi_agents.agents.utils.file_formats.write_text_to_md') as mock_md:
            with patch('multi_agents.agents.utils.file_formats.write_md_to_pdf') as mock_pdf:
                with patch('multi_agents.agents.utils.file_formats.write_md_to_word') as mock_docx:
                    ...
                    for path in [mock_md.return_value, mock_pdf.return_value, mock_docx.return_value]:
