...
class DetailedTester:
                            ...
                            try:
                                ...
                                if response.status_code == 200:
                                    ...
                                    if expected_mime in actual_mime:
                                        ...
                                        mime_results[file_ext] = (
                                            f"❌ Expected: {expected_mime}, Got: {actual_mime}"
                                        )
    ...
    async def test_api_response_structure(self):
        ...
        async with httpx.AsyncClient(base_url=self.base_url, timeout=30.0) as client:
            ...
            health_fields = {"status": str, "active_sessions": int, "websocket_connections": int}
